...
class ProfileDataProvider extends StatelessWidget {
  const ProfileDataProvider({Key? key}) : super(key: key);
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text('المقر',style: TextStyle(fontWeight: FontWeight.w400,fontSize: 16.sp),),
              ),
              Padding(
                padding:  EdgeInsets.only(right: 51.w,left: 37.h,top: 10.h),
                child: Container(
              ...
              Padding(
                padding:  EdgeInsets.only(top: 25.h,left: 212.w,right: 68.w),
                child: Text('ايميلك',style: TextStyle(fontWeight: FontWeight.w400,fontSize: 16.sp),),
              ),
              Padding(
                padding:  EdgeInsets.only(right: 51.w,left: 37.h,top: 10.h),
                child: Container(
