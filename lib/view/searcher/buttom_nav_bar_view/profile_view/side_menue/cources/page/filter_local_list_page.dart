...
import 'package:gesr/view/searcher/buttom_nav_bar_view/profile_view/side_menue/cources/page/group_data.dart';
import 'package:gesr/view/searcher/buttom_nav_bar_view/profile_view/side_menue/cources/page/my_Groups.dart';
...
class FilterCources extends StatefulWidget {
  @override
  FilterCourcesState createState() => FilterCourcesState();
}

class FilterCourcesState extends State<FilterCources> {
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            onTap: () => {Navigator.push(context, MaterialPageRoute(builder: (c) => FilterCources()))},
          ),
          SizedBox(
            height: 35.h,
          ),
