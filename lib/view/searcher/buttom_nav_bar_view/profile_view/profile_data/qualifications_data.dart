...
class QualificationDataSearcher extends StatefulWidget {
  const QualificationDataSearcher({Key? key}) : super(key: key);

  @override
  State<QualificationDataSearcher> createState() =>
      _QualificationDataSearcherState();
}

class _QualificationDataSearcherState extends State<QualificationDataSearcher> {
  int index = 0;
