...
import 'package:gesr/view/followers/followers.dart';
...
class SearcherProfile extends StatelessWidget {
  const SearcherProfile({Key? key}) : super(key: key);
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              ListTile(
                ...
                onTap: () => {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (c) => FilterCources()))
                },
              ),
              SizedBox(
                height: 35.h,
                        ...
                        InkWell(
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      const QualificationDataSearcher()),
                            );
                          },
                          child: Container(
                            width: 131.w,
