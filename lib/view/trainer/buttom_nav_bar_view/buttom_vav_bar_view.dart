...
import 'package:gesr/view/trainer/buttom_nav_bar_view/profile_view/profile_view.dart';
import 'package:gesr/view/trainer/buttom_nav_bar_view/provider_message/home_get_job.dart';
import 'package:gesr/view/trainer/buttom_nav_bar_view/trainer_cources/provider_jobs.dart';
import 'package:gesr/view/trainer/buttom_nav_bar_view/trainer_cources/searcher_profile_Trainer/searcher_profile_provider.dart';
class TrainerProfileButtomViews extends StatefulWidget {
  const TrainerProfileButtomViews({Key? key}) : super(key: key);

  @override
  _ButtomViewsState createState() => _ButtomViewsState();
}

class _ButtomViewsState extends State<TrainerProfileButtomViews> {
  List<Widget> screens = [
